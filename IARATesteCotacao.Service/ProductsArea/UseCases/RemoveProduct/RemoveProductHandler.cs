...
{
    public class RemoveProductHandler : IRequestHandler<RemoveProductCommand, ApiResult>
    {
        ...
        public async Task<ApiResult> Handle(RemoveProductCommand request, CancellationToken cancellationToken)
        {
            ...
            await _productRepository.DeleteAsync(productResult);
